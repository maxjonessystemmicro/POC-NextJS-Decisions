...
export default async function handler(req, res) {
  if (req.method === 'GET') {
    try {
      ...
      const url = new URL("https://decisions-systemmicro.ca/Primary/restapi/Flow/01JEVEEF00DPBQTRA3NJVZRT0J");
      url.searchParams.append('guest', 'true');
      url.searchParams.append('outputtype', 'Json');
      if (FloorPlanID) {
        url.searchParams.append('FloorPlanID', FloorPlanID); // Add RoomID to the query parameters
      }
